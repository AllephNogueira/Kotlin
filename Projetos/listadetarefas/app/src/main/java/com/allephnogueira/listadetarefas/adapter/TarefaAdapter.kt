package com.allephnogueira.listadetarefas.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.allephnogueira.listadetarefas.databinding.ItemTarefaBinding
...
class TarefaAdapter() : RecyclerView.Adapter<TarefaAdapter.TarefaViewHolder>() {
    ...
    fun adicionarLista(lista: List<Tarefa>){
        ...
        notifyDataSetChanged() // Esse metodo serve para notificar o recyclerView para ele recarregar os dados.
    }
