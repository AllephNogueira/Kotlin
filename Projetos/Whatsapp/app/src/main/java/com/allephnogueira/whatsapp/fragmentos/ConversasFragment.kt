...
import com.allephnogueira.whatsapp.databinding.FragmentConversasBinding
...
class ConversasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.rvConversas.addItemDecoration(
            // Aqui é um divisor para cada item que o recyclerView vai criar.
                ...
                .addSnapshotListener { querySnapshot, erro ->
                    ...
                    documentos?.forEach { documentSnapshot ->
                        ...
                        if (conversa != null) {
                            ...
                            Log.i("exibicao_conversas", "adicionarListenerConversas: ${conversa.nome} - ${conversa.ultimaMensagem} ")
                        }
                    }
