...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnExecutar.setOnClickListener {
            /**
             * Nova aula 149.2
             * Aqui nao vamos fazer nada aqui dentro, vamos fazer tudo la dentro do AdapterAgenda
             *
             * Vamos fazer basicamente: Adicionar um novo item na lista e atualizar a lista de contatos.
             *
             * vamos passar como parametro os dados, para simular como se a gente tivesse pego de um editText
             */

//            val contato = "Crixus"
//            val telefone = "21988180461"
//            contatoAdapter.executarOperacao(contato, telefone)
//
//
//            val contato2 = "Jane"
//            val telefone2 = "123456789"
//
//            contatoAdapter.executarOperacao(contato2, telefone2)


            /**
             * Aula 150.0
             * Agora vamos notificar um item que foi atualizado ou removido
             * Agora estamos chamando o metodo que vamos atualizar o contato
             * O contato que vamos atualizar esta la no adapter, mas poderiamos colocar ele aqui tambem
             */

            contatoAdapter.notificandoItemAtualizadoOuRemovido()
